...
const LoginModal = () => {
    ...
    const privateRouter = useSelector((state: any) => state.auth.modalOpen);
                            ...
                            <>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex  backdrop-blur-md bg-gray-100/10 rounded-2xl p-3 w-full">
                                        <button className='flex-1 text-xl rounded-xl font-extrabold' onClick={handleRegister}>Đăng ký </button>
                                    </div>
